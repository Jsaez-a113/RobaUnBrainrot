"""
Django settings for RobaUnBrainrot project.
...
SECRET_KEY = 'django-insecure-ve8j_7b_uew=sj)%copkmpt=@1@ka72s3*fhylt-(-mot-ezx8'
...
ROOT_URLCONF = 'RobaUnBrainrot.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.brainrot_stats',
            ],
        },
    },
]

WSGI_APPLICATION = 'RobaUnBrainrot.wsgi.application'
